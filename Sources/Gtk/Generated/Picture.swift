...
addSignal(name: "notify::alternative-text", handler: gCallback(handler0)) { [weak self] (param0: OpaquePointer) in
...
addSignal(name: "notify::can-shrink", handler: gCallback(handler1)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::content-fit", handler: gCallback(handler2)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::file", handler: gCallback(handler3)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::keep-aspect-ratio", handler: gCallback(handler4)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::paintable", handler: gCallback(handler5)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
