...
let handler3: @convention(c) (UnsafeMutableRawPointer, GtkDeleteType, Int, UnsafeMutableRawPointer) -> Void =
    { _, value1, value2, data in
        SignalBox2<GtkDeleteType, Int>.run(data, value1, value2)
    }

addSignal(name: "delete-from-cursor", handler: gCallback(handler3)) { [weak self] (param0: GtkDeleteType, param1: Int) in
    guard let self = self else { return }
    self.deleteFromCursor?(self, param0, param1)
}

let handler4: @convention(c) (UnsafeMutableRawPointer, GtkTextExtendSelection, GtkTextIter, GtkTextIter, GtkTextIter, UnsafeMutableRawPointer) -> Void =
    { _, value1, value2, value3, value4, data in
        SignalBox4<GtkTextExtendSelection, GtkTextIter, GtkTextIter, GtkTextIter>.run(data, value1, value2, value3, value4)
    }

addSignal(name: "extend-selection", handler: gCallback(handler4)) { [weak self] (param0: GtkTextExtendSelection, param1: GtkTextIter, param2: GtkTextIter, param3: GtkTextIter) in
    guard let self = self else { return }
    self.extendSelection?(self, param0, param1, param2, param3)
}

let handler5: @convention(c) (UnsafeMutableRawPointer, UnsafePointer<CChar>, UnsafeMutableRawPointer) -> Void =
    { _, value1, data in
        SignalBox1<UnsafePointer<CChar>>.run(data, value1)
    }

addSignal(name: "insert-at-cursor", handler: gCallback(handler5)) { [weak self] (param0: UnsafePointer<CChar>) in
    guard let self = self else { return }
...
let handler7: @convention(c) (UnsafeMutableRawPointer, GtkMovementStep, Int, Bool, UnsafeMutableRawPointer) -> Void =
    { _, value1, value2, value3, data in
        SignalBox3<GtkMovementStep, Int, Bool>.run(data, value1, value2, value3)
    }

addSignal(name: "move-cursor", handler: gCallback(handler7)) { [weak self] (param0: GtkMovementStep, param1: Int, param2: Bool) in
    guard let self = self else { return }
    self.moveCursor?(self, param0, param1, param2)
}

let handler8: @convention(c) (UnsafeMutableRawPointer, GtkScrollStep, Int, UnsafeMutableRawPointer) -> Void =
    { _, value1, value2, data in
        SignalBox2<GtkScrollStep, Int>.run(data, value1, value2)
    }

addSignal(name: "move-viewport", handler: gCallback(handler8)) { [weak self] (param0: GtkScrollStep, param1: Int) in
    guard let self = self else { return }
...
let handler10: @convention(c) (UnsafeMutableRawPointer, UnsafePointer<CChar>, UnsafeMutableRawPointer) -> Void =
    { _, value1, data in
        SignalBox1<UnsafePointer<CChar>>.run(data, value1)
    }

addSignal(name: "preedit-changed", handler: gCallback(handler10)) { [weak self] (param0: UnsafePointer<CChar>) in
    guard let self = self else { return }
...
addSignal(name: "notify::accepts-tab", handler: gCallback(handler14)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::bottom-margin", handler: gCallback(handler15)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::buffer", handler: gCallback(handler16)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::cursor-visible", handler: gCallback(handler17)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::editable", handler: gCallback(handler18)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::extra-menu", handler: gCallback(handler19)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::im-module", handler: gCallback(handler20)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::indent", handler: gCallback(handler21)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::input-hints", handler: gCallback(handler22)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::input-purpose", handler: gCallback(handler23)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::justification", handler: gCallback(handler24)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::left-margin", handler: gCallback(handler25)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::monospace", handler: gCallback(handler26)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::overwrite", handler: gCallback(handler27)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::pixels-above-lines", handler: gCallback(handler28)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::pixels-below-lines", handler: gCallback(handler29)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::pixels-inside-wrap", handler: gCallback(handler30)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::right-margin", handler: gCallback(handler31)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::tabs", handler: gCallback(handler32)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::top-margin", handler: gCallback(handler33)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::wrap-mode", handler: gCallback(handler34)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::hadjustment", handler: gCallback(handler35)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::hscroll-policy", handler: gCallback(handler36)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::vadjustment", handler: gCallback(handler37)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::vscroll-policy", handler: gCallback(handler38)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
public var extendSelection: ((TextView, GtkTextExtendSelection, GtkTextIter, GtkTextIter, GtkTextIter) -> Void)?
