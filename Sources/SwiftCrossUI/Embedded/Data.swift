// Extracted from swift foundation essentials
...
// // TODO: Make sure this works; could be a problem with the shims
// #warning("Make sure this works; could be a problem with the shims")
...
@_extern(c, "getpagesize")
fileprivate func getpagesize() -> Int
...
@_extern(c, "malloc")
@usableFromInline func malloc(_ size: Int) -> UnsafeMutableRawPointer?

@_extern(c, "calloc")
@usableFromInline func calloc(_ count: Int, _ size: Int) -> UnsafeMutableRawPointer?
...
@_extern(c, "memset")
@usableFromInline
func memset(_ ptr: UnsafeMutableRawPointer, _ value: Int32, _ size: Int) -> UnsafeMutableRawPointer

@_extern(c, "memcpy")
@usableFromInline
func memcpy(_ dest: UnsafeMutableRawPointer, _ src: UnsafeRawPointer, _ size: Int) -> UnsafeMutableRawPointer

@_extern(c, "memcmp")
@usableFromInline
func memcmp(_ lhs: UnsafeRawPointer, _ rhs: UnsafeRawPointer, _ size: Int) -> Int32
...
@_extern(c, "munmap")
@usableFromInline
func munmap(_ addr: UnsafeMutableRawPointer, _ length: Int) -> Int32
...
extension Data {
    init(contentsOf url: URL, options: ReadingOptions = []) throws {
        ...
        // FIXME: Implement URL loading for Image.
